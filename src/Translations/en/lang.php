...
return [
    ...
    */
    ...
    'nav-active-tickets'               => 'Tickets Ativos',
    'nav-completed-tickets'            => 'Tickets Finalizados',
    ...
    */
    ...
    // tickets/____
    'index-my-tickets'                 => 'Meus Tickets',
    'btn-create-new-ticket'            => 'Criar novo Ticket',
    'index-complete-none'              => 'Nenhum Ticket Finalizado',
    'index-active-check'               => 'Se você não achar seu Ticket. Verifique Tickets Ativos.',
    'index-active-none'                => 'Nenhum Ticket Ativo,',
    'index-create-new-ticket'          => 'Criar novo Ticket',
    'index-complete-check'             => 'Se você não achar seu Ticket. Verifique Tickets Fechados.',

    'create-ticket-title'              => 'Novo Formulário de Ticket',
    'create-new-ticket'                => 'Criar Novo Ticket',
    'create-ticket-brief-issue'        => 'Descreva brevemente o problema encontrado',
    'create-ticket-describe-issue'     => 'Descreva o problema em detalhes',

    'show-ticket-title'                => 'Ticket',
    'show-ticket-js-delete'            => 'Tem certeza que deseja excluir: ',
    'show-ticket-modal-delete-title'   => 'Excluir Ticket',
    'show-ticket-modal-delete-message' => 'Tem certeza que deseja excluir Ticket: :subject?',
    ...
    */
    ...
    'priority-all-tickets-here'        => 'Todas prioridades dos Tickets relacionadas aqui',
    ...
    'status-all-tickets-here'        => 'O Status de todos Tickets está relacionados aqui',
...
//  IsAdminMiddleware IsAgentMiddleware ResAccessMiddleware
  'you-are-not-permitted-to-access-this-page'     => 'Você não tem permissão para acessar esta página!',
    ...
    'notify-created-ticket'            => ' criou o Ticket ',
    'notify-updated'                   => ' Atualizado ',

    // TicketsController
    'the-ticket-has-been-created'      => 'O Ticket foi Criado!',
    'the-ticket-has-been-modified'     => 'O Chamdo foi Modificado!',
    'the-ticket-has-been-deleted'      => 'O Ticket :name foi Excluido!',
    'the-ticket-has-been-completed'    => 'O Ticket :name foi Finalizado!',
    'the-ticket-has-been-reopened'     => 'O Ticket :name foi Re-aberto!',
